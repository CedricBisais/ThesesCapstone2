...
<body id="body-pd">
        ...
        <nav class="nav">
            <div><a href="#" class="nav_logo"><i class='bx bx-layer nav_logo-icon'></i><span class="nav_logo-name">BBBootstrap</span></a>
                <div class="nav_list">
                    ...
                    <a href="#" class="nav_link"><i class='bx bx-bookmark nav_icon'></i><span class="nav_name">Course Management</span></a>
    ...
    <div class="container-fluid px-4">
                ...
                <div class="row my-5">
                    <h3 class="fs-4 mb-3">Recent Logins</h3>
                    <div class="col">
