		...
		<div class="table-wrapper">
			...
			<table id="UserTable" table class="table table-striped table-hover">
                ...
                <tbody>
                        ...
                        $sql = "SELECT * FROM tbl_coursedept";
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            <tr>
                                ...
                                <td>{$row['course']}</td>
                                <td>
                                    <a href='#editCourseModal' class='editbtn' data-toggle='modal'><i class='material-icons' data-toggle='tooltip' title='Edit'>&#xE254;</i></a>
...
<div id="editCourseModal" class="modal fade">
	<div class="modal-dialog">
        ...
        <div class="modal-header">
            ...
            <form action="adminCourseEdit.php" method="POST">
                <div class="modal-body">
